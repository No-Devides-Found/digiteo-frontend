        ...
        <Grid item xs={5}>
          ...
          <Grid container style={{ paddingLeft: "3rem" }}>
            ...
            <Grid
              item
              xs={12}
              style={{ fontFamily: "Kumbh Sans", fontSize: "8" }}
              mt={2}
            >
              <StyledContent variant="subtitle1">
                <strong>창작마루</strong>(실습)란?
                <br />
                <strong>디지털 놀이터</strong>(학습)에 1개 이상의 프로그램을
                듣고
                <br />
                <strong>
                  본인이 원하는 형태의 디지털 콘텐츠를 제작하여 <br />
                  공유할 수 있는 커뮤니티
                </strong>
                입니다. <br />
                놀이터 프로그램들은 마지막에 과제 제출 시 가이드라인과 <br />
                예시가 주어지지만 창작마루에는 본인이 학습한
                <br />
